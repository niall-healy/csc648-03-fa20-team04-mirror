...
INSERT INTO listing(id, name, timestamp, description, price, category) VALUES (1, 'Car', NOW(), 'Cool car', 20000, 'Automotive');
INSERT INTO listing(id, name, timestamp, description, price, category) VALUES (2, 'Room', NOW(), 'Cool room', 2000, 'Housing');
INSERT INTO listing(id, name, timestamp, description, price, category) VALUES (3, 'Book', NOW(), 'Cool book', 2000, 'Textbooks');
INSERT INTO listing(id, name, timestamp, description, price, category) VALUES (4, 'Pineapple car', NOW(), 'Cool pineapple car', 2000, 'Automotive');
INSERT INTO listing(id, name, timestamp, description, price, category) VALUES (5, 'Apple car', NOW(), 'Cool apple car', 2000, 'Automotive');
